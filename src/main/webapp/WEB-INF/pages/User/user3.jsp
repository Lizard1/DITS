...
<div class="container">
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-5">
            <form method="get" action="#" modelAttribute="crForm">
                <div class="form-group">
                    ...
                    <p><input class="form-control" type="text" placeholder="Ответ"/></p>
                    <p><input class="form-control" type="text" placeholder="Ответ"/></p>
                    <p><input class="form-control text-white bg-primary" type="submit" name="submit" value="Следующий"></p>
                </div>
            </form>
            <div class="col-5 justify-content-md-center">
                <button class="btn bg-primary">
                    <a id="alog" href='<c:url value="/user/chooseTest" />' class="text-white">Назад</a>
                </button>
            </div>
        </div>
    </div>
